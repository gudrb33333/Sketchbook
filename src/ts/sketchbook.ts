...
const btnUnmuteMic = document.getElementById('btnUnmuteMic')
const btnEnableWebcam = document.getElementById('btnEnableWebcam')
const btnDisableWebcam = document.getElementById('btnDisableWebcam')
const btnEnableShare = document.getElementById('btnEnableShare')
const btnDisableShare = document.getElementById('btnDisableShare')

btnConnectWebRtc.addEventListener('click', connectWebRtc)
